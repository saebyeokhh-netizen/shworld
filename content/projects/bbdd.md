...
가장 오래 붙잡은 버그는 **설정 창의 X 버튼이 눌리지 않는** 문제였습니다. 제목 표시줄에서 물음표 버튼만 떼어내려다 닫기 기능까지 함께 지워버린 것인데, 버튼은 멀쩡히 그려져 있어서 원인을 찾기까지 한참 걸렸습니다. **화면에 보이는 것과 실제 상태가 다를 수 있다**는 걸 이때 배웠습니다.
